...
public class AmplitudeOscillatorTest extends Application {
	...
	private static void testGetSample() {
		// double[] getSample(LinearAmplitudeEnvelope linearAmplitudeEnvelope, WaveType
		                   // waveType, float samplesPerSecond)
		...
		AmplitudeOscillator ao = new AmplitudeOscillator(startingFrequency, endingFrequency, startingAmplitudeWidth,
		...
		data.add(ao.getSample(linearAmplitudeEnvelope, waveType, samplesPerSecond));
	}

	private static void testGetAmpEnvelope() {
		// double[] getAmplitudeArray(double seconds, float samplesPerSecond)
		// double[] getOscillator(double seconds, WaveType waveType, float
		// samplesPerSecond)
		System.out.println("Constructing AmplitudeOscillator with...");
		System.out.println("Starting frequency of 1...");
		System.out.println("Ending frequency of 0.1...");
		...
		double seconds = 16;
		float samplesPerSecond = (float) Math.pow(2.0, 5);
		data.add(ao.getAmplitudeArray(seconds, samplesPerSecond));
	}
	...
	private static void testAmpOscAmpConstructor() {
		...
		AmplitudeOscillator ao = new AmplitudeOscillator(startingFrequency, endingFrequency, startingAmplitudeWidth,
				endingAmplitudeWidth, radians);
		System.out.println("Constructing AmplitudeOscillator...");
		System.out.println("Starting frequency of 1...");
		System.out.println("Ending frequency of 1...");
		System.out.println("Starting amplitude width of 10...");
		System.out.println("Ending amplitude width of 15...");
		...
		AmplitudeOscillator ao2 = new AmplitudeOscillator(startingFrequency, endingFrequency, startingAmplitudeWidth,
				endingAmplitudeWidth, radians);
		double seconds = 16;
