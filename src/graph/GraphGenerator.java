...
public class GraphGenerator {
	...
	/**        Generates one graph cycle, where one Object loops
	 * @param  Object as the graph Object that will make up the generated graph cycle
	 ...
	 * @return one graph cycle, where one Object loops
	 */
	...
	/**        Generates one graph cycle, where each Object loops and is part of a linear cycle
	 * @param  Object as the graph nodes that will make up the generated graph cycle
	 * @param  loops as the maximum number of times the nodes should loop
	...
	/**        Generates one graph cycle, where the chance of getting each single looped Object is random
	 * @param  Object as the graph nodes that will make up the generated graph cycle and the first Object is the starting Object
	 * @param  startingObject as the Object that the cycle starts at before choosing a random Object 	 
	 * @param  loops as the maximum number of times the nodes should loop
