...
public class SquareWaveTest extends Application {
	...
	/*
		SquareWave(double amplitude, double hertz, double radians, boolean updateRadians)
	...
	public static void main(String[] args) {
		...
		//testSquareWavePhase();
		//testSquareWaveShort();
		//testSquareWaveAmpArray();
		launch(args);
	}

	private static void testSquareWaveAmpArray() {
		System.out.println("Constructing SquareWave with amplitude of 10...");
		...
		SquareWave sw = new SquareWave(amplitude, hertz, radians, updateRadians);
		System.out.print("Get amplitude: ");
		System.out.println(sw.getAmplitude());
		System.out.println("Constructing SquareWave with amplitude of 5...");
		System.out.println("Frequency of 4...");
		System.out.println("And phase of 0...");
		amplitude = 5;
		SquareWave sw2 = new SquareWave(amplitude, hertz, radians, updateRadians);
		System.out.print("Get amplitude: ");
	...
	private static void testSquareWaveShort() {
		System.out.println("Constructing SquareWave with amplitude of 10...");
	...
	private static void testSquareWavePhase() {
		System.out.println("Constructing SquareWave with amplitude of 10...");
		System.out.println("Frequency of 1...");
		System.out.println("And phase of 0...");
		double amplitude = 10;
	...
	private static void testSquareWaveFreq() {
		System.out.println("Constructing SquareWave with amplitude of 10...");
		System.out.println("Frequency of 1...");
		System.out.println("And phase of 0...");
		double amplitude = 10;
	...
	private static void testSquareWaveAmp() {
		System.out.println("Constructing SquareWave with amplitude of 10...");
		System.out.println("Frequency of 1...");
		System.out.println("And phase of 0...");
		double amplitude = 10;
	...
	private void labelAxis() {
		primaryStage.setTitle("SquareWave Test");
		Text text = new Text("SquareWave getWave() methods");
		root.getChildren().add(text);
		xAxis.setLabel("Sample Numer");
		yAxis.setLabel("Amplitude");
		scatterChart.setTitle("SquareWave getWave() methods");			
	}
