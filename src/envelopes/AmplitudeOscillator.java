 ...
 * @since 2019 A class for making amplitude oscillators
 */
public class AmplitudeOscillator {
	...
	// This will create a wave that starts with a wave that goes from
	// (-startAmpWidth) to (startAmpWidth)
	...
	// This will create a wave that starts with a wave that goes from (-endAmpWidth)
	// to (endAmpWidth)
	 ...
	 * 
	 * @param startingFrequency      as the oscillation rate at the start of the
	 *                               oscillator
	 * @param endingFrequency        as the oscillation rate at the end of this
	 *                               oscillator
	 * @param startingAmplitudeWidth as the starting amplitude width of this
	 *                               oscillator. This will create a wave that starts
	 *                               with a wave that goes from (-startAmpWidth) to
	 *                               (startAmpWidth)
	 * @param endingAmplitudeWidth   as the ending amplitude width of this
	 *                               oscillator. This will create a wave that starts
	 *                               with a wave that goes from (-endAmpWidth) to
	 *                               (endAmpWidth)
	 * @param radians                as the phase of the wave generated by this
	 *                               class
	 */
	public AmplitudeOscillator(double startingFrequency, double endingFrequency, double startingAmplitudeWidth,
			double endingAmplitudeWidth, double radians) {
	...
	public double[] getOscillator(double seconds, WaveType waveType, float samplesPerSecond) {
		...
		for (int i = 0; i < wave.length - 1; i++) {
			assert waveType != null;
			waveObject = switch (waveType) {
				case TRIANGLE -> new TriangleWave((startingAmplitudeWidth - (amplitudeWidthSlope * i)),
					((startingFrequency - (frequencySlope * (i)))), radians, updateRadians);
				case SAW -> new SawWave((startingAmplitudeWidth - (amplitudeWidthSlope * i)),
					((startingFrequency - (frequencySlope * (i)))), radians, updateRadians);
				case SQUARE -> new SquareWave((startingAmplitudeWidth - (amplitudeWidthSlope * i)),
					((startingFrequency - (frequencySlope * (i)))), radians, updateRadians);
				case NOISE -> new NoiseWave((startingAmplitudeWidth - (amplitudeWidthSlope * i)));
				default -> new SineWave((startingAmplitudeWidth - (amplitudeWidthSlope * i)),
					((startingFrequency - (frequencySlope * (i)))), radians, updateRadians);
			};
		...
		assert waveType != null;
		waveObject = switch (waveType) {
			case TRIANGLE -> new TriangleWave((startingAmplitudeWidth - (amplitudeWidthSlope * wave.length)),
				((startingFrequency - (frequencySlope * (wave.length)))), radians, updateRadians);
			case SAW -> new SawWave((startingAmplitudeWidth - (amplitudeWidthSlope * wave.length)),
				((startingFrequency - (frequencySlope * (wave.length)))), radians, updateRadians);
			case SQUARE -> new SquareWave((startingAmplitudeWidth - (amplitudeWidthSlope * wave.length)),
				((startingFrequency - (frequencySlope * (wave.length)))), radians, updateRadians);
			case NOISE -> new NoiseWave((startingAmplitudeWidth - (amplitudeWidthSlope * wave.length)));
			default -> new SineWave((startingAmplitudeWidth - (amplitudeWidthSlope * wave.length)),
				((startingFrequency - (frequencySlope * (wave.length)))), radians, updateRadians);
		};
		temp = waveObject.getWave(1.0 / samplesPerSecond, samplesPerSecond);
	...
	/**
	 * Creates an amplitude array with this oscillator combined with an AmplitudeEnvelope.
	 * @param linearAmplitudeEnvelope as the AmplitudeEnvelope to create the base of
	 *                                this oscillator
	...
	public double[] getSample(LinearAmplitudeEnvelope linearAmplitudeEnvelope,
		...
		linearAmplitudeEnvelope.addAmplitudeOscillator(this, waveType, samplesPerSecond);
		return (linearAmplitudeEnvelope.getEnvelope());
	}
}
